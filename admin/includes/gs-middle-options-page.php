            ...
            <div class="wgc-box-body">
                <table>
                    <tr>
                        ...
                        <td><label for="frontend_admin_menu_status">Enabled frontend admin menu?</label></td>
                    </tr>
                    <tr>
                        ...
                        <td><label for="frontend_admin_menu_admin_bar">Hide frontend admin bar?</label></td>
                    </tr>
                </table>
            </div>
        </div>
